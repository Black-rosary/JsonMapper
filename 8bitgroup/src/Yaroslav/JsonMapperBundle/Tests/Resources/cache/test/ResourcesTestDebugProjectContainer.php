...
class ResourcesTestDebugProjectContainer extends Container
{
    ...
    public function __construct()
    {
        ...
        $this->methodMap = array(
            ...
            'yaroslav_json_mapper.default_adapter' => 'getYaroslavJsonMapper_DefaultAdapterService',
            'yaroslav_json_mapper_test1' => 'getYaroslavJsonMapperTest1Service',
        );
        $this->aliases = array(
    ...
    {
        return $this->services['cache.app'] = new \Symfony\Component\Cache\Adapter\FilesystemAdapter('fN-xCLiTQD', '', (__DIR__.'/pools'));
    }
    ...
    {
        return $this->services['cache.system'] = \Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('tp4l60plhB', '', 'PxO3GElAa9ZicW1V4FN2vA', (__DIR__.'/pools'), NULL);
    }
    ...
    protected function getCacheClearerService()
    {
        ...
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('+GRoDNRZtG', '', 'PxO3GElAa9ZicW1V4FN2vA', (__DIR__.'/pools'), NULL));
        $a->addPool(\Symfony\Component\Cache\Adapter\AbstractAdapter::createSystemCache('ebGrRYhHFJ', '', 'PxO3GElAa9ZicW1V4FN2vA', (__DIR__.'/pools'), NULL));
    ...
    {
        return $this->services['uri_signer'] = new \Symfony\Component\HttpKernel\UriSigner('xxxx');
    }
    ...
    /**
     * Gets the 'yaroslav_json_mapper.default_adapter' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Yaroslav\JsonMapperBundle\Adapter\AnyAdapter A Yaroslav\JsonMapperBundle\Adapter\AnyAdapter instance
     */
    protected function getYaroslavJsonMapper_DefaultAdapterService()
    {
        return $this->services['yaroslav_json_mapper.default_adapter'] = new \Yaroslav\JsonMapperBundle\Adapter\AnyAdapter();
    }

    /**
     * Gets the 'yaroslav_json_mapper_test1' service.
     *
     * This service is shared.
     * This method always returns the same instance of the service.
     *
     * @return \Yaroslav\JsonMapperBundle\Mapper\JsonMapper A Yaroslav\JsonMapperBundle\Mapper\JsonMapper instance
     */
    protected function getYaroslavJsonMapperTest1Service()
    {
        return $this->services['yaroslav_json_mapper_test1'] = new \Yaroslav\JsonMapperBundle\Mapper\JsonMapper('http://127.0.0.1:8001/', 'AppBundle/Entity/LocationCollection', array('locations' => array('type' => 'AppBundle/Entity/Location[]', 'mapping' => array('name' => array('type' => 'string'), 'coordinates' => array('type' => 'AppBundle/Entity/Coordinates', 'mapping' => array('long' => array('type' => 'float'), 'lat' => array('type' => 'float')))))), new \Yaroslav\JsonMapperBundle\Tests\Resources\Adapter\DummyAdapter());
    }
    ...
    protected function getDefaultParameters()
    {
        return array(
            ...
            'kernel.bundles' => array(
                ...
                'YaroslavJsonMapperBundle' => 'Yaroslav\\JsonMapperBundle\\YaroslavJsonMapperBundle',
            ),
            ...
            'yaroslav_json_mapper.default_adapter.class' => 'Yaroslav\\JsonMapperBundle\\Adapter\\AnyAdapter',
            'yaroslav_json_mapper.json_mapper.class' => 'Yaroslav\\JsonMapperBundle\\Mapper\\JsonMapper',
